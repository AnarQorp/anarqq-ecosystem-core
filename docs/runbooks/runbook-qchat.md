...
3. Check memory usage: `ps aux | grep qchat`
...
```bash
# Scale up
docker-compose up -d --scale qchat=3

# Scale down
docker-compose up -d --scale qchat=1
```
...
- **Primary Contact**: qchat-team@q.network
