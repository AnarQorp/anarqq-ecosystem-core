...
3. Check memory usage: `ps aux | grep squid`
...
```bash
# Scale up
docker-compose up -d --scale squid=3

# Scale down
docker-compose up -d --scale squid=1
```
...
- **Primary Contact**: squid-team@q.network
