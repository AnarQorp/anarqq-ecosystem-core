...
3. Check memory usage: `ps aux | grep qmarket`
...
```bash
# Scale up
docker-compose up -d --scale qmarket=3

# Scale down
docker-compose up -d --scale qmarket=1
```
...
- **Primary Contact**: qmarket-team@q.network
