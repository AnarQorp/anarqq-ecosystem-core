...
3. Check memory usage: `ps aux | grep qnet`
...
```bash
# Scale up
docker-compose up -d --scale qnet=3

# Scale down
docker-compose up -d --scale qnet=1
```
...
- **Primary Contact**: qnet-team@q.network
