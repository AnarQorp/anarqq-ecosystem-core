...
3. Check memory usage: `ps aux | grep qonsent`
...
```bash
# Scale up
docker-compose up -d --scale qonsent=3

# Scale down
docker-compose up -d --scale qonsent=1
```
...
- **Primary Contact**: qonsent-team@q.network
