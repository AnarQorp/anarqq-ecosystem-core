...
3. Check memory usage: `ps aux | grep qdrive`
...
```bash
# Scale up
docker-compose up -d --scale qdrive=3

# Scale down
docker-compose up -d --scale qdrive=1
```
...
- **Primary Contact**: qdrive-team@q.network
