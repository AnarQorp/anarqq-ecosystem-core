...
3. Check memory usage: `ps aux | grep qindex`
...
```bash
# Scale up
docker-compose up -d --scale qindex=3

# Scale down
docker-compose up -d --scale qindex=1
```
...
- **Primary Contact**: qindex-team@q.network
